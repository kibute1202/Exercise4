package com.hnam.exerciseweek3.fragment;
...
import com.hnam.exerciseweek3.Activity.DetailMovieActivity;
...
public class MovieFragment extends Fragment implements MovieAdapter.MovieItemClickListener {
    ...
    private void loadData() {
        urlData = title.equals(Constants.TAG_NOW_PLAYING) ?
                Constants.URL_NOW_PLAYING_API : Constants.URL_TOP_RATE_API;
        ...
        okHttpClient.newCall(request).enqueue(new Callback() {
            ...
            public void onResponse(Call call, final Response response) throws IOException {
                if (response.isSuccessful()) {
                    ...
                    if (movie != null) {
                        getActivity().runOnUiThread(() -> {
                            adapter = new MovieAdapter(MovieFragment.this.getContext(),
    ...
    public void onItemClick(Result result) {
        Intent detailIntent = new Intent(this.getContext(), DetailMovieActivity.class);
